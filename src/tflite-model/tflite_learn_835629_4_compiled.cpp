 ...
 */
// Generated on: 30.11.2025 08:20:03
...
const TfArray<1, float> quant0_scale = { 1, { 0.01111674215644598, } };
const TfArray<1, int> quant0_zero = { 1, { -9 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(8) int32_t tensor_data1[3] = { 12, -4, -5, };
const TfArray<1, int> tensor_dimension1 = { 1, { 3 } };
const TfArray<1, float> quant1_scale = { 1, { 0.0011661926982924342, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[3*10] = { 
  -5, -7, 127, -23, -16, 13, 4, -23, -25, 3, 
  64, 59, -44, -22, -25, 8, -4, -22, -8, -12, 
  -23, -20, -10, 27, -6, -3, -9, 2, 52, 25, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 3,10 } };
const TfArray<1, float> quant2_scale = { 1, { 0.032061953097581863, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[10] = { -6, -11, 296, 81, -2, 14, -18, -26, 19, 86, };
const TfArray<1, int> tensor_dimension3 = { 1, { 10 } };
const TfArray<1, float> quant3_scale = { 1, { 0.00027886778116226196, } };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[10*20] = { 
  21, -5, -4, 11, 12, -1, 51, -16, -5, -5, 0, -1, 35, 53, 33, -19, 11, -8, -6, 1, 
  18, -10, 64, 20, 7, -4, 31, -11, -13, 9, -7, -6, 66, 52, 76, -7, 16, 5, 17, -3, 
  -26, -7, -16, 109, -6, -7, -27, 6, -5, 59, 5, 7, -12, -24, -24, 127, 33, -14, -20, -10, 
  11, 12, 15, -5, -8, 37, -5, -1, -2, 7, 42, 26, -10, -13, 1, -3, -4, -6, 16, 40, 
  -5, 13, -14, -6, -15, 7, -3, 3, -17, 8, 11, 5, -5, 6, 2, -11, -9, 12, 10, 5, 
  -13, 7, -12, 2, -12, -22, -4, 4, -23, -12, 3, 0, -12, 4, -8, -12, -10, 1, -12, -7, 
  16, 8, -5, -10, 8, 7, 5, -8, -11, 1, 4, 1, -9, -4, 3, -4, 9, -9, 1, -11, 
  -2, 23, 3, 0, 2, 37, 9, -12, 45, -14, -7, 47, 4, -10, -18, 6, 7, 9, 0, 37, 
  11, 15, 9, 0, 37, 21, -13, 2, -2, -4, 39, 15, -3, -15, -3, 15, -14, 32, -6, -1, 
  9, -1, 1, 0, 22, 38, 0, 14, 26, -13, -6, 22, -10, -7, 8, 7, -2, 31, 3, 31, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 10,20 } };
const TfArray<1, float> quant4_scale = { 1, { 0.019966833293437958, } };
const TfLiteAffineQuantization quant4 = { (TfLiteFloatArray*)&quant4_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data5[20] = { -174, -102, -196, 699, -46, -26, -113, -7, 288, 638, 344, 327, -130, -93, -101, 796, 637, 295, -136, 272, };
const TfArray<1, int> tensor_dimension5 = { 1, { 20 } };
const TfArray<1, float> quant5_scale = { 1, { 0.00010125972767127678, } };
...
TfLiteStatus tflite_learn_835629_4_init( void*(*alloc_fnc)(size_t,size_t) ) {
...
TfLiteStatus tflite_learn_835629_4_input(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(in_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_835629_4_output(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(out_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_835629_4_invoke() {
...
TfLiteStatus tflite_learn_835629_4_reset( void (*free_fnc)(void* ptr) ) {
#ifdef EI_CLASSIFIER_ALLOCATION_HEAP
